# This is Crypt/Blowfish.pm which is an implementation of Bruce Schneier's blowfish
...
B<Crypt::Blowfish> - Blowfish encryption algorithm

=head1 SYNOPSIS

C<use Crypt::Blowfish>
...
The B<Crypt::Blowfish> module provides for users to use the Blowfish encryption
